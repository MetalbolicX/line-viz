...
<div align="center">
  <img src="./images/logo.png" alt="line-viz Logo" width="200" height="200" />
</div>

> `line-viz` small slogan.
...
```json
{
  "bs-dependencies": ["line-viz"]
}
```

## 🙌 Hello World Example

Here's a simple example of how to use `line-viz` to create a reactive UI component:
...
To build and run your ReScript application, see the [Compile and Run](https://metalbolicx.github.io/line-viz/#/compile-run) section.

## 📚 Documentation

<div align="center">

  [![view - Documentation](https://img.shields.io/badge/view-Documentation-blue?style=for-the-badge)](https://metalbolicx.github.io/line-viz/#/api-reference)
